        ...
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold" style="color:#FF3333 "><span >MY </span>LAPTOP</h1>
                </a>
                <p>Mọi thắc mắc xin vui lòng liên hệ:</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>K147 Lê Đình Lý, Hải Châu, Đà Nẵng</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>dinhphuc14042001@gmail.com</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+84-35338475</p>
            </div>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    &copy; <a class="text-dark font-weight-semi-bold" href="#">MY LAPTOP</a>. Đã đăng ký Bản quyền. Thiết kế bởi
                    <a class="text-dark font-weight-semi-bold" href="https://www.facebook.com/profile.php?id=100026751636172" target="blank">Phuc Nguyen</a>
                </p>
            </div>
