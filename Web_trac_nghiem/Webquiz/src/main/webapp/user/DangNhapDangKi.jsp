...
<div>
    <img src="/image/bg3.jpg" style="position: absolute;
        top: 0;
        left: 0;
        width: 100%;
        height: 100%;
...
<div class="container">
    ...
    <div class="cover">
        <div class="front">
            <img src="/static/img/dang_ki.jpg" alt="">
<%--            <div class="text">--%>
<%--                <span class="text-1">Trắc nghiệm trực tuyến <br> </span>--%>
<%--                <span class="text-2">Đa dạng-Thông minh-Chính xác</span>--%>
<%--            </div>--%>
        </div>
        <div class="back">
...
<%--                            <label for="show-password-checkbox">Hiện mật khẩu</label>--%>
<%--                        </div>--%>
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="button" id="show-password-checkbox" onclick="togglePasswordVisibility()" style="border: 2px solid; margin-top: 12px;">
                        ...
                        <c:if test="${sai == 1}">
                            ...
                            <%--                 Quên mật khẩu       --%>
                        <div class="text"><a href="/user/forgotPassword.jsp" style="color: #1d91a7">Quên mật khẩu ?</a></div>


                        <div class="button input-box">
                            <input onclick="onSubmitLoginForm()" type="button" value="Đăng nhập">
                        </div>
                        <div class="text sign-up-text">Bạn chưa có tài khoản? <label for="flip" id="registerLabel">Đăng kí </label></div>
                        <div class="text sign-up-text">
                            <i class="fa-solid fa-house" style="color: #1d91a7;"></i>
                            <a href="/" style="color: #1d91a7">Về trang chủ</a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="signup-form">
                ...
                <form id="form-dangky" action="/userServlet" method="post" name="register">
                    ...
                    <div class="input-boxes">
                        ...
                        <div class="text sign-up-text">Bạn đã có tài khoản? <label for="flip">Đăng nhập </label></div>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    function togglePasswordVisibility() {
        var passwordInput = document.getElementById("passwordLoginInput");
