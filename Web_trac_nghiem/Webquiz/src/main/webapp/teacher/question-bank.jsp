...
<c:if test="${sessionScope.account.idRole == 3}">
            ...
            <div class="row">
                ...
                <div class="col-10 content">
                    ...
                    <nav class="navbar justify-content-between">
                        ...
                        <form method="get" action="/teacher/questions" class="form-inline d-flex">
                            ...
                            <c:forEach var="question" items="${listQuestion}" varStatus="loop">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="/teacher/questions" method="POST" id="updateQuestionForm${loop.index}">
                                ...
                                <div class="modal fade" id="confirmDeleteModal${loop.index}" tabindex="-1"  aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="/teacher/questions" method="post" id="deleteQuestionForm${loop.index}" class="modal-content">
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination pagination-sm justify-content-center">
                                        <li class="page-item ${currentPage <= 1?"disabled":""}">
                                            <c:url value="/teacher/questions" var="prevUrl">
                                        ...
                                        <c:forEach var="i" begin="1" end="${maxPages}">
                                            ...
                                            <c:if test="${ i < currentPage  && currentPage - i <= 2}">
                                                <li class="page-item">
                                                    <a class="page-link" href="/teacher/questions?index=${i}">${i}</a>
                                                </li>
                                            </c:if>
                                        ...
                                        <li class="page-item ${currentPage >= maxPages?"disabled":""}">
                                            <c:url value="/teacher/questions" var="nextUrl">
                                                <c:param name="index" value="${currentPage + 1}"/>
                                            </c:url>
    ...
    <div class="modal fade" id="createQuestionModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/teacher/questions" method="POST" id="createQuestionForm">
    ...
    <div class="modal fade" id="createFileModal" tabindex="-1" aria-labelledby="modalCreateFile" aria-hidden="true">
        <div class="modal-dialog">
            <form  action="/teacher/questions" method="post" enctype="multipart/form-data" class="modal-content" id="importQuestionForm">
