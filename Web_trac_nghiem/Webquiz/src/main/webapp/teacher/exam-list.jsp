...
<html lang="en">
<head>
    <jsp:include page="/teacher/view/head.jsp"/>
    <title> Website thi trắc nghiệm online</title>
    <link rel="stylesheet" href="/static/css/exam-list.css">
</head>
<body>
<jsp:include page="/teacher/view/header.jsp"/>
<div class="main">
    <div class="container-fluid">
        <div class="row">
            <jsp:include page="/teacher/view/left_navbar.jsp"/>
                    ...
                    <table border="1" cellpadding="4" class="table table-hover">
                        ...
                        <c:forEach var="exam" items="${listExam}" varStatus="loop">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <form method="post" action="/teacher/examQuestion">
                                        ...
                                        <button class="btn btn-outline-dark btn-sm" type="button"
                                                data-bs-toggle="modal" data-bs-target="#inModal${loop.index}" style="margin: 0 8px">
                                            In đề
                                        </button>
                                    </div>
                                </td>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="updateExamForm${loop.index}" action="/teacher/exams" method="POST">
                            ...
                            <%--                            modal in để--%>
                            <div class="modal fade" id="inModal${loop.index}" tabindex="-1" ria-labelledby="deleteModalLabel1" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form onsubmit="onPrintExam()" action="/admin/exams" method="post"
                                              class="modal-content">
                                            <input type="hidden" name="action" value="print">
                                            <input type="hidden" name="idExa" value="${exam.examId}">
                                            <input type="hidden" name="name1" value="${exam.examName}">
                                            <input type="hidden" name="action" value="delete">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Xác nhận in Đề ${exam.examId}</h5>

                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                Xác nhận in đề ${exam.examName}?
                                            </div>
                                            <div class="modal-footer">
                            ...
                            <div class="modal fade" id="deleteModal1${loop.index}" tabindex="-1" ria-labelledby="deleteModalLabel1" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form onsubmit="onDeleteExam()" action="/teacher/exams" method="post"
                                              class="modal-content">
                                            <input type="hidden" name="idExa" value="${exam.examId}">
                                            <input type="hidden" name="action" value="delete">
                                            <div class="modal-header">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination pagination-sm justify-content-center">
                                    <li class="page-item ${currentPage <= 1?"disabled":""}">
                                        <c:url value="/teacher/exams" var="prevUrl">
                                    ...
                                    <c:forEach var="i" begin="1" end="${maxPages}">
                                        <li class="page-item ${currentPage == i?"active":""}">
                                            <a class="page-link" href="/teacher/exams?index=${i}">${i}</a>
                                        </li>
                                    </c:forEach>
                                    <li class="page-item ${currentPage >= maxPages?"disabled":""}">
                                        <c:url value="/teacher/exams" var="nextUrl">
                                            <c:param name="index" value="${currentPage + 1}"/>
                                        </c:url>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createExamForm" action="/teacher/exams" method="post">
